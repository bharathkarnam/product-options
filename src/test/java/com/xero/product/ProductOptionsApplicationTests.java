...
import com.xero.product.it.ProductOptionIntegrationTest;
...
@RunWith(Suite.class)
@ActiveProfiles("test")
@Suite.SuiteClasses({ProductControllerTest.class, ProductandOptionContollerTest.class, ProductOptionsServiceTest.class,
        ProductServiceTest.class, ProductOptionIntegrationTest.class,
        ProductDaoImplTest.class, ProductOptionsDaoImplTest.class})
